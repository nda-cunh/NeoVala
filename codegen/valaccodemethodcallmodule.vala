...
public class Vala.CCodeMethodCallModule : CCodeAssignmentModule {
	public override void visit_method_call (MethodCall expr) {
		...
		if (m is CreationMethod && m.parent_symbol is Class) {
			...
			} else if (gsource_type != null && current_class.is_subtype_of (gsource_type)) {
				// g_source_new
		...
		if (m is CreationMethod && m.parent_symbol is Class && ((current_class.is_compact && current_class.base_class != null) || (gsource_type != null && current_class.is_subtype_of (gsource_type)))) {
